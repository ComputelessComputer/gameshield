import { UPDATE_PRIORITY as d } from "./index294.js";
import { TickerListener as h } from "./index603.js";
const n = class i {
  constructor() {
   ...
   */
  add(t, e, s = d.NORMAL) {
    return this._addListener(new h(t, e, s));
  }
  /**
   ...
   * @returns This instance of a ticker
   */
  addOnce(t, e, s = d.NORMAL) {
    return this._addListener(new h(t, e, s, !0));
  }
  /**
  ...
  update(t = performance.now()) {
    ...
    if (t > this.lastTime) {
      ...
      this.deltaMS = e, this.deltaTime = this.deltaMS * i.targetFPMS;
      const s = this._head;
      let a = s.next;
      for (; a; )
  ...
  set minFPS(t) {
    const e = Math.min(this.maxFPS, t), s = Math.min(Math.max(0, e) / 1e3, i.targetFPMS);
